...
//                 child: Padding(
//                   padding:
//                       EdgeInsets.only(left: 34.0, right: 34.0, top: 16),
//                   child: RaisedButton(
...
//                 child: Padding(
//                   padding:
//                       EdgeInsets.only(left: 34.0, right: 34.0, top: 8),
//                   child: RaisedButton(
...
// RaisedButton({required Color textColor, required Color color, required Null Function() onPressed, required RoundedRectangleBorder shape, required Padding child}) {
// }
