...
class OnBoarding1View extends StatelessWidget {
  ...
  const OnBoarding1View({super.key, required this.animationController});
            ...
            children: [
              ...
              SlideTransition(
                ...
                child: const Padding(
                  ...
                  child: Text(
                    "Dive into the world of recycling by exploring our extensive range of waste categories. From glass and plastic to paper and more, learn how every item can find its right place for a greener planet.",
              ...
              SlideTransition(
                ...
                child: Container(
                  ...
                  child: Image.asset(
                    'assets/onboarding_landing/1.png',
                    fit: BoxFit.contain,
                  ),
                ),
              ),
